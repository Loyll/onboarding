...
onboardingScriptsUrl="https://github.com/Loyll/onboarding/raw/main/onboarding_scripts.zip" # Enter your own URL here
appname="onBoarding"                                                 
...
# Generated variables
tempdir="/Library/Application Support/Microsoft/IntuneScripts/onBoardingTemp"
