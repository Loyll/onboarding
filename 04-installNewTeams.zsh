...
if [[ $(uname -m) == 'arm64' ]]; then
    ...
    weburl="https://statics.teams.cdn.office.net/production-osx/enterprise/webview2/lkg/MicrosoftTeams.pkg" 
    else
    # This is x64 URL
    weburl="https://statics.teams.cdn.office.net/production-osx/enterprise/webview2/lkg/MicrosoftTeams.pkg"   
fi
...
waitForProcess () {
    ...
    updateSplashScreen wait Attente
...
function downloadApp () {
    ...
    updateSplashScreen progress Téléchargement
    ...
    if [[ $? == 0 ]]; then
         ...
         updateSplashScreen fail Échec du téléchargement
...
function updateCheck() {
    ...
    if [[ $autoUpdate == "true" ]]; then
        ...
        updateSplashScreen success Installé
        exit 0;
    fi
        ...
        if [[ -d "$logandmetadir" ]]; then
            ...
            if [ -f "$metafile" ]; then
                ...
                if [[ "$previouslastmodifieddate" != "$lastmodified" ]]; then
                    ...
                    updateSplashScreen progress Mise à jour requise
                    update="update"
                else
...
function installPKG () {
    ...
    updateSplashScreen progress Installation
